...
\input{sections/1.Header.tex}

\input{sections/2.Title.tex}
...
\input{sections/5.Assumtions and Notations.tex}

\input{sections/6.Preliminary Analyses.tex}


\clearpage


\input{sections/7.Task 1.tex}

\clearpage


\input{sections/8.Task 2.tex}

\clearpage



\input{sections/9.Task 3.tex}
